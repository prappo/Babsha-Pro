                        ...
                        <div class="bs-glyphicons">
                            <ul class="bs-glyphicons-list">
                                <li><h3><span class="fa fa-money" aria-hidden="true"></span></h3> <span
                                            class="glyphicon-class"><h4><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e(\App\Income::sum('money')); ?></h4>Earning</span>
                                </li>
                                <li><h3><span class="fa fa-shopping-cart" aria-hidden="true"></span></h3> <span
                                            class="glyphicon-class"><h4><?php echo e(\App\Orders::distinct()->get(['orderId'])->where('status','pending')->count()); ?></h4>Orders</span>
                                </li>
                                <li><h3><span class="fa fa-list" aria-hidden="true"></span></h3> <span
                                            class="glyphicon-class"><h4><?php echo e(\App\Products::count()); ?></h4>Products</span>
                                </li>
                                <li><h3><span class="fa fa-users" aria-hidden="true"></span></h3> <span
                                            class="glyphicon-class"><h4><?php echo e($user = \App\User::count()); ?></h4><?php if($user >=1): ?>
                                            User <?php else: ?> Users <?php endif; ?></span>
                                </li>
                                ...
                                <li><h3><span class="fa fa-th" aria-hidden="true"></span></h3> <span
                                            class="glyphicon-class"><h4><?php echo e(\App\Catagories::count()); ?></h4>Categories</span>
                                </li>
                                <li><h3><span class="fa fa-paypal" aria-hidden="true"></span></h3> <span
                                            class="glyphicon-class"><h4><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e(\App\Payments::sum('amount')); ?></h4>PayPal</span>
                                </li>
                                <li><h3><span class="fa fa-bell" aria-hidden="true"></span></h3> <span
                                            class="glyphicon-class"><h4><?php echo e(\App\Notifications::count()); ?></h4>Notifications</span>
                                </li>
                            </ul>
                        </div>
