                        ...
                        <table id="mytable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <?php foreach($orders as $order): ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\App\Orders::where('orderId',$order->orderId)->where('userId',Auth::user()->id)->count()); ?> <?php if(\App\Orders::where('productid',$order->productId)->count() > 1): ?>
                                    ...
                                    <td><?php if(\App\Http\Controllers\Customer::getAdddress($order->sender) == "none"): ?><?php echo e(\App\Http\Controllers\Customer::getName($order->sender)); ?>
                                        ...
                                        ,<?php echo e(\App\Http\Controllers\Customer::getPostalCode($order->sender)); ?>  <?php endif; ?></td>
                                    <td><?php echo e($order->created_at); ?></td>
                                    <td>

                                        <?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('currency')); ?><?php echo e(\App\Orders::where('orderId',$order->orderId)->sum('price')); ?>
