                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('subTitle')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('phone')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="email" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('email')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('address')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('afterOrderMsg')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('map')); ?>"
                                ...
                                <div class="col-md-6">
                                    <form id="uploadimage" method="post" enctype="multipart/form-data">
                                        ...
                                        <input class="btn btn-xs btn-success" type="submit" value="Upload"
                                               id="imgUploadBtn"/>
                                        <input type="hidden" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('logo')); ?>"
                                               id="image">
                                        <div id="imgMsg"></div>
                                    </form>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('tax')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e(\App\Settings::where('userId',Auth::user()->id)->value('shipping')); ?>"
