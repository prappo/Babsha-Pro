                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e($name); ?>" class="form-control" id="title">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="<?php echo e($short_description); ?>" class="form-control" id="shortDescription">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea id="longDescription" class="form-control" rows="3"><?php echo e($description); ?></textarea>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" id="category">
                                        <?php foreach($categories as $cat): ?>
                                            <option <?php if($cat['name'] == $category): ?> selected <?php endif; ?> value="<?php echo e($cat['id']); ?>"  ><?php echo e($cat['name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        $('#updateproduct').click(function () {
            ...
            $.ajax({
                type:'POST',
                url:'<?php echo e(url('/woo/update/product')); ?>',
                data:{
                    'id':$('#proId').val(),
                    'title':$('#title').val(),
