                                ...
                                <div class="panel-body">
                                    ...
                                    <?php foreach(\App\Orders::distinct()->where('orderId',$orderNumber)->get(['productid','sender','orderId','type']) as $order): ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if($order->type == "woo"): ?>
                                                <div class="col-md-2"><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e($woo->price); ?></div>
                                                <div class="col-md-2"><?php echo e((\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())); ?></div>
                                                <div class="col-md-2"><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e($woo->price * (\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())); ?></div>
                                            <?php else: ?>
                                                <div class="col-md-2"><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e(\App\Products::where('id',$order->productid)->value('price')); ?></div>
                                                <div class="col-md-2"><?php echo e((\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())); ?></div>
                                                <div class="col-md-2"><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e((\App\Products::where('id',$order->productid)->value('price')) * (\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; ?>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <b><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e($subTotal); ?></b></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <b><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e($tax = \App\Http\Controllers\Data::getTax()); ?></b>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <b><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e(\App\Http\Controllers\Data::getShippingCost()); ?></b>
                                        </div>
                                    </div>
                                    <div style="border-top: 1px solid #8c8b8b;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <b><?php echo e(\App\Http\Controllers\Data::getUnit()); ?><?php echo e(\App\Http\Controllers\Data::getShippingCost() + \App\Http\Controllers\Data::getTax() + $subTotal); ?></b>
                                            </div>
                                        </div>
                                    </div>
                                </div>
