                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{$shortDescription}}" class="form-control" id="shortDescription">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea id="longDescription" class="form-control" rows="3">{{$longDescription}}</textarea>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" id="category">
                                        @foreach($categories as $cat)
                                            <option @if($cat->name == $category) selected @endif >{{$cat->name}}</option>
                                        @endforeach
                                    </select>
