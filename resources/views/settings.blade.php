                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input value="{{\App\Http\Controllers\Data::getToken()}}" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input value="{{\App\Http\Controllers\Data::getAppId()}}" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input value="{{\App\Http\Controllers\Data::getAppSec()}}" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{\App\Http\Controllers\Data::getShopTitle()}}"
                            ...
                            <div class="form-group">
                                <img id="imagePreview" src="{{\App\Http\Controllers\Data::getLogo()}}" height="50" width="50">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{\App\Http\Controllers\Data::getPaymentMethod()}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{\App\Http\Controllers\Settings::get('paypalClientSecret')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{\App\Http\Controllers\Settings::get('wooConsumerKey')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{\App\Http\Controllers\Settings::get('wooConsumerSecret')}}"
